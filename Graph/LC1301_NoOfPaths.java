...
Approach: Use dynamic programming to find the maximum score and count of paths.
...
class LC1301_NoOfPaths {
    ...
    public static void main(String[] args) {
        LC1301_NoOfPaths obj = new LC1301_NoOfPaths();
        List<String> board = Arrays.asList("E23", "2X2", "12S");
        int[] res = obj.pathsWithMaxScore(board);
