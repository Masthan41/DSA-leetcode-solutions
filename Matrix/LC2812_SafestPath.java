/*
LeetCode 2812 - Safest Path in a Grid
Approach: Binary Search, BFS
Key Idea:
Using binary search on the safeness factor and BFS to check if a path exists with the given minimum safeness factor.
Time Complexity: O(n^2 * log(n)) where n is the size of the grid, due to binary search and BFS.
...
class LC2812_SafestPath {
    ...
    public static void main(String[] args) {
        ...
        int sf = solution.maximumSafenessFactor(grid);
        System.out.println("Maximum Safeness Factor: " + sf);
    }
}