class LC3255_MaxScore {
    ...
    long solve(boolean prevTaken, int prevHeight, int col,
        ...
        for (int height = 0; height <= n; height++) {
            ...
            long takeCurrent = currColScore + prevColScore +
                    solve(true, height, col + 1, grid, colPrefSum);

            long skipCurrent = prevColScore +
    ...
    public static void main(String[] args) {
        LC3255_MaxScore solution = new LC3255_MaxScore();
        int[][] grid = { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } };
        System.out.println(solution.maximumScore(grid)); // Output: 30
    }
}
