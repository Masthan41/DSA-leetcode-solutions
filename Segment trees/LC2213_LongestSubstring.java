...
Approach: we use segment tree to find the maximum length of a substring with one repeating character.
...
class LC2213_LongestSubstring {
    ...
    public static void main(String[] args) {
        LC2213_LongestSubstring solution = new LC2213_LongestSubstring();
        String s = "babacc";
