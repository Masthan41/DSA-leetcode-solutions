...
class LC3500_MaximizeSelectionII {
    ...
    public static void main(String[] args) {
        LC3500_MaximizeSelectionII solution = new LC3500_MaximizeSelectionII();
        String s = "110001100";
        int[][] queries = { { 0, 8 }, { 2, 5 }, { 1, 6 } };
        List<Integer> result = solution.maxActiveSectionsAfterTrade(s, queries);
        System.out.println("Max active sections after trade for each query: " + result);
    }
}
